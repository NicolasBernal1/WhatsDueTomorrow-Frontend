...
export class AssignmentService {
  ...
  getUpcomingAssignments(): Observable<BaseResponseDto<AssignmentResponseCompDto[]>> {
    return this.http.get<BaseResponseDto<AssignmentResponseCompDto[]>>(`${this.apiUrl}/assignments/upcoming`);
  }

  getUrgentAssignments(): Observable<BaseResponseDto<AssignmentResponseCompDto[]>> {
    return this.http.get<BaseResponseDto<AssignmentResponseCompDto[]>>(`${this.apiUrl}/assignments/urgent`);
  }
